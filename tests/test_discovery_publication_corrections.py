...
RECENT_PUB_DATE = (datetime.now(timezone.utc) - timedelta(days=1)).strftime("%Y-%m-%d")
            ...
            return [
                {
                    ...
                    "description": "Retrato",
                    "published_at": f"{RECENT_PUB_DATE}T10:00:00Z",
...
def test_corr_pub_06_valid_partial_batch(app):
    ...
    for i in range(1, 7):
        search_results.append({
            ...
            "published_at": f"{RECENT_PUB_DATE}T{10+i}:00:00Z",
...
def test_corr_pub_07_isolated_categories(app):
    ...
    search_items_cat1.append({
        ...
        "description": "Estudio",
        "published_at": f"{RECENT_PUB_DATE}T18:00:00Z",
